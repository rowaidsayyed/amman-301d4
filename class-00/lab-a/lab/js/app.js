...
function displayPics(){
  ...
  // When decleration was using var, the variables were global which mean that we can use them inside the function and when we use const the variables become localy inside the block only so we can use it only inside the loop block
  console.log(viewed);
